...
// Version 2 - Dynamic Loading (EXPANDED VIEW)
javascript:
function(){
	var jsCode = document.createElement('script');
}
jsCode.setAttribute('src','https://raw.githubusercontent.com/ccgthree/SSEOrderCheck/master/SSEOrderCheckLinkTest.js');
document.body.appendChild(jsCode);
jsCode.addEventListener('load', displayLink());
